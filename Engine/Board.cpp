...
void Board::Background()
{
	...
	// top
	gfx.DrawRect(left + borderWidth, top + borderWidth, right - borderWidth, bottom - borderWidth, backgroundColor);
}

void Board::setBackground(Color c)
{
	backgroundColor = c;
}
